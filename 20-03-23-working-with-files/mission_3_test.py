def main():
    ...
    options_to_choose(the_final_movies_list, backup_movies_list)
...
def storing(data):
    ...
    #movies_list = movies_list + updated_movies_list
    backup_movies_list = list(movies_list)
    return movies_list, backup_movies_list
    

def database(movies_list):          # big list, ready to make a list of dict (movies_list)
...
def options_to_choose(the_final_movies_list, backup_movies_list):
    ...
    while show_menu:
        ...
        if option == "1":            
            ...
            actor_search(updated_movies_list)
        elif option == "3":
            genre_search(updated_movies_list)
        elif option == "4":
...
def adding_to_database(backup_movies_list):
    ...
    updated_movies_list = backup_movies_list + new_movie
    ...
    if second_question == "yes":
        ...
        return updated_movies_list  # needed for database
